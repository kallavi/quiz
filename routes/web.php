...
Route::get('/',[MainController::class, 'quiz'])->name('quiz.join');
Route::post('quiz/result',[MainController::class, 'result'])->name('quiz.result');
Route::get('quiz/detay',[MainController::class, 'quiz_detail'])->name('quiz.detail');
